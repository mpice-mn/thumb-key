...
import com.dessalines.thumbkey.keyboards.THUMBKEY_EN_V4_MULTILINGUAL_KEYBOARD_MODES
...
fun keyboardLayoutToModes(layout: KeyboardLayout): Map<KeyboardMode, KeyboardC> {
    return when (layout) {
        ...
        KeyboardLayout.ThumbKeyENv4Intl -> THUMBKEY_EN_V4_MULTILINGUAL_KEYBOARD_MODES
